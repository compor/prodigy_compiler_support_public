...
namespace {
struct SinValIndirection : public ModulePass {
  static char ID;
  SinValIndirection() : ModulePass(ID) {}
...
char SinValIndirection::ID = 0;
static RegisterPass<SinValIndirection> X("SinValIndirection", "Ranged Indirection for Project",
...
static RegisterStandardPasses Y(
    ...
    [](const PassManagerBuilder &Builder,
           legacy::PassManagerBase &PM) { PM.add(new SinValIndirection()); });
